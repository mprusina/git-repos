...
import com.mprusina.gitrepo.databinding.FragmentFavoriteReposListRowBinding

class FavoriteReposListAdapter(
    private val onFavoriteClickListener: (Repo) -> Unit
) : ListAdapter<Repo, FavoriteReposListAdapter.ViewHolder>(DIFF_CALLBACK) {

    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): ViewHolder {
        return ViewHolder(FragmentFavoriteReposListRowBinding.inflate(LayoutInflater.from(parent.context), parent, false))
    }
    ...
    inner class ViewHolder(private val binding: FragmentFavoriteReposListRowBinding) : RecyclerView.ViewHolder(binding.root) {
